...
{
    public class KT_PushOrderWeatherObject
    {
        /// <summary>
        /// 显示序号
        /// </summary>
        ...
        public KT_PushOrderWeatherObject()
        {

        }

        public KT_PushOrderWeatherObject(XElement xml)
        {
            if(xml != null)
            {
        ...
        public KT_PushOrderWeatherObject(DataRow dataRow)
        {
            if (dataRow != null)
            {
