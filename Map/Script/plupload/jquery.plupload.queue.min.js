    ...
    function b(f, e) {
        ...
        e
				.prepend('<div class="plupload_wrapper plupload_scroll"><div id="'
						...
						+ a("开始上传")
						+ '</a></div><span class="plupload_upload_status"></span><div class="plupload_progress"><div class="plupload_progress_container"><div class="plupload_progress_bar"></div></div></div></div><div class="plupload_file_action"></div><div class="plupload_file_status"><span class="plupload_total_status">0%</span></div><div class="plupload_file_size"><span class="plupload_total_file_size">0 b</span></div><div class="plupload_clearer">&nbsp;</div></div></div></div></div><input type="hidden" id="'
						+ f
						+ '_count" name="'
						+ f
						+ '_count" value="0" /></div>')
        ...
        if (e) {
            this.each(function () {
                ...
                function h(l) {
                    ...
                    c("#" + l.id).attr("class", m).find("a").css("display",
							"block")
                }
                function f() {
                    ...
                    c("div.plupload_progress_bar", i).css("width",
							j.total.percent + "%");
                    c("span.plupload_upload_status", i).text("已上传 "
...
function addImage(name, originalUrl, thumbnailUrl) {
    var thumbs_url = "/Upload.aspx?act=Thumbnail&ThumbnailId=" + name;
    //alert(name);
    var newImg = document.createElement("img");
    newImg.style.margin = "5px";
    newImg.setAttribute("class", "thumbnail");
    //   newImg.setAttribute("onclick", "javascript:alert('" + src + "');");        
    newImg.setAttribute("onclick", "InsertImages('" + name + "','" + originalUrl + "', '" + thumbnailUrl + "')");
